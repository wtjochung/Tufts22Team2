...
public class MicInput : MonoBehaviour
{
    ...
    public static float MicMaxLoudnessinDecibels = 0;
    ...
    float MicrophoneLevelMax()
    {
       ...
       // Debug.Log("MicrophoneLevelMax = " + levelMax);
        return levelMax;
    }
    ...
    public float FloatLinearOfClip(AudioClip clip)
    {
       ...
       // Debug.Log("floatlinearofclip = " + levelMax);
        return levelMax;
    }
    ...
    void Update()
    {
       ...
       /* Debug.Log("update");
        if (MicMaxLoudnessinDecibels < MicLoudnessinDecibels)
        {
            Debug.Log("max in micinput: " + MicMaxLoudnessinDecibels);
            MicMaxLoudnessinDecibels = MicLoudnessinDecibels;
        }*/
